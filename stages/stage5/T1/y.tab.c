...
static const char *const yytname[] =
{
  ...
  "CONTINUE", "REPEAT", "UNTIL", "DECL", "ENDDECL", "INT", "STR", "LT",
  "LE", "GT", "GE", "EE", "NE", "';'", "','", "'['", "']'", "'('", "')'",
  "'&'", "$accept", "start", "Declarations", "DeclList", "Decl", "Type",
  "Varlist", "Gid", "ParamList", "Param", YY_NULLPTR
};
#endif
...
{
     -19,   -23,    16,   -39,   -17,   -39,   -39,   -18,   -39,    -3,
     -39,   -39,   -16,   -39,   -26,    17,   -36,   -39,   -39,    21,
     -13,   -39,   -39,    -3,   -22,    22,   -38,   -39,   -39,   -14,
     -39,   -13,   -39,    25,   -39,   -12,   -39
};
...
{
       0,     0,     0,     2,     0,     8,     9,     0,     6,     0,
       1,     4,     0,     5,    12,     0,     0,    11,     3,     0,
      19,    15,     7,     0,     0,     0,     0,    18,    10,    13,
      20,     0,    16,     0,    17,     0,    14
};
...
{
     -39,   -39,   -39,   -39,    18,   -20,   -39,     6,   -39,     0
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     7,     8,     9,    16,    17,    26,    27
};
...
{
      25,    14,    31,    22,    23,    15,    32,     4,     5,     6,
       1,    25,    12,     5,     6,    19,    10,    20,     5,     6,
      29,    21,    11,    18,    24,    13,    30,    33,    35,    28,
      36,    34
};

static const yytype_uint8 yycheck[] =
{
      20,     4,    40,    39,    40,     8,    44,    30,    31,    32,
      29,    31,    30,    31,    32,    41,     0,    43,    31,    32,
      42,     4,    39,    39,     3,     7,     4,    41,     3,    23,
      42,    31
};
...
static const yytype_uint8 yystos[] =
{
       ...
       0,    39,    30,    50,     4,     8,    52,    53,    39,    41,
      43,     4,    39,    40,     3,    51,    54,    55,    53,    42,
       4,    40,    44,    41,    55,     3,    42
};
