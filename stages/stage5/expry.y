...
Program		:GDeclBlock FDefBlock MainBlock		{printf("Syntax Matched\n");
												if($3==NULL){puts("Nothing to execute :)");}
												generate($3,target_file);}
			|GDeclBlock MainBlock				{printf("Syntax Matched\n");
												puts("No functions! :)");
												if($2==NULL){puts("Nothing to execute :)");}
												generate($2,target_file);}
			|MainBlock							{printf("Syntax Matched\n");
												puts("No global variables declared!! :)");
												puts("No functions declared!! :)");
												generate($1,target_file);}
			;
//-------------------------------------------------------------------------
