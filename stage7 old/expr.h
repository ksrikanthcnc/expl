...
typedef struct tnode {
	...
	struct CFieldlist *cfield;}tnode;
...
struct Gsymbol{
	...
	char *tuplename;
	//-------------for class
	struct Gsymbol* next;}*ghead;

struct Paramstruct{
	char* name;
	struct Typetable *type;
	struct Paramstruct* next;}*phead;

struct Lsymbol{
	char *name;
	struct Typetable *type;
	int binding;
	struct Lsymbol *next;}*lhead;

struct Typetable{
    char *name;
    int size;
    struct Fieldlist *fields;
    struct Typetable *next;}*thead;
