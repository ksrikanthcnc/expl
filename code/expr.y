...
id 				:ID							{$$=createtree(Lookup($1->str)->type,NULL,$1->str,nt_ID,NULL,NULL,NULL);}
				...
				|MUL ID						{$$=createtree($2->t,Lookup($2->str)->binding,$2->str,nt_SPTR,NULL,NULL,NULL);}
				|'&' ID						{$$=createtree($2->t,Lookup($2->str)->binding,$2->str,nt_APTR,NULL,NULL,NULL);}
				;
%%
