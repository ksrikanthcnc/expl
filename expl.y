...
//-------------------------------------------------------------------------start
	start		:Program;
	Program		:TDeclBlock CDeclBlock GDeclBlock FDefBlock {generate();} MainBlock		{printf("\n\n\n\nSyntax Matched\n");}
				;
//-------------------------------------------------------------------------type
...
//-------------------------------------------------------------------------body
	...
	Stmt		:READ '(' id ')' ';'								{$$=createtree(TLookup("void"),0,NULL,nt_READ,NULL,$3,NULL,NULL,NULL,NULL);}
				...
				|id EQ ALLOC '(' ')' ';'							{$$=createtree(TLookup("void"),GetSize(TLookup($1->str)),NULL,nt_ALLOC,NULL,$1,NULL,NULL,NULL,NULL);}
